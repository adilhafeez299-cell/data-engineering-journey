...
# created new folder in directory
else:
...
#Checking if the file is file path or file directory
...
# Removing directory
if os.path.exists(directory_path):  # ✅ "if directory DOES exist"
    dir_files = os.listdir(directory_path)
    for file in dir_files:
        os.remove(os.path.join(directory_path, file))
    os.rmdir(directory_path)
    print(f"Directory was removed: {directory_path}")
    #you are not allowed to remove directory if not empty
